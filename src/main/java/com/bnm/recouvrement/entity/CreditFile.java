...
public class CreditFile {
    ...
    public CreditFile(String title, String filePath, String creditNumber, Double montant, LocalDateTime dateEcheance, LocalDateTime uploadDate, DossierRecouvrement dossier) {
        this.title = title;
