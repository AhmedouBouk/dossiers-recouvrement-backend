...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        List<String> defaultPermissions = List.of(
            ...
            "IMPORT_CLIENT","IMPORT_COMPTE", "CREATE_COMPTE", "READ_COMPTE", "UPDATE_COMPTE", "DELETE_COMPTE",
         ...
         "DELETE_DOSSIERRECOUVREMENT", "DOWNLOAD_DOSSIERRECOUVREMENT","READ_DOSSIERRECOUVREMENT",
